    ...
    <>
      ...
      <div className={styles.section}>
        ...
        <div className={styles.auditRow}>
          ...
          {error ? (
          ...
          ) : data?.configSync?.results?.length ? (
                      ...
                      {allIds.map((ruleId: string) => {
                        ...
                        return (
                          <div key={ruleId} className={styles.ruleItem}>
                            ...
                            <span className={`${styles.ruleLabel} ${passed ? styles.ruleLabelPassed : ""}`}>
            ...
            <div className={styles.rowLoading}>No config sync data</div>
          ) : null}
        </div>
      </div>
